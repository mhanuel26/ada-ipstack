...
package body Net.Buffers is
   ...
   function Get_Data_Address_Pos (Buf : in Buffer_Type; Pos : Uint16) return System.Address is
   begin
      return Buf.Packet.Data (Pos)'Address;
   end Get_Data_Address_Pos;
   ...
   begin
      Buf.Packet.Data (Buf.Pos)     := Net.Uint8 (Interfaces.Shift_Right (Uint_16 (Value), 8));
      Buf.Packet.Data (Buf.Pos + 1) := Net.Uint8 (Uint_16 (Value) and 16#0ff#);
      Buf.Pos := Buf.Pos + 2;
   end Put_Uint16;
   ...
   begin
      Buf.Packet.Data (Buf.Pos)     := Net.Uint8 (Interfaces.Shift_Right (Uint_32 (Value), 24));
      Buf.Packet.Data (Buf.Pos + 1) := Net.Uint8 (Interfaces.Shift_Right (Uint_32 (Value), 16) and 16#0ff#);
      Buf.Packet.Data (Buf.Pos + 2) := Net.Uint8 (Interfaces.Shift_Right (Uint_32 (Value), 8) and 16#0ff#);
      Buf.Packet.Data (Buf.Pos + 3) := Net.Uint8 (Uint_32 (Value) and 16#0ff#);
      Buf.Pos := Buf.Pos + 4;
   end Put_Uint32;
   ...
   begin
      Buf.Pos := Pos + 2;
      return Net.Uint16 (Interfaces.Shift_Left (Net.Uint_16 (Buf.Packet.Data (Pos)), 8)
        or Net.Uint_16 (Buf.Packet.Data (Pos + 1)));
   end Get_Uint16;
   ...
   begin
      Buf.Pos := Pos + 4;
      return Net.Uint32 (Interfaces.Shift_Left (Net.Uint_32 (Buf.Packet.Data (Pos)), 24)
        or Interfaces.Shift_Left (Net.Uint_32 (Buf.Packet.Data (Pos + 1)), 16)
        or Interfaces.Shift_Left (Net.Uint_32 (Buf.Packet.Data (Pos + 2)), 8)
        or Net.Uint_32 (Buf.Packet.Data (Pos + 3)));
   end Get_Uint32;
