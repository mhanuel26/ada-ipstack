   ...
   begin
      ...
      if No (Err) then
         case ICMPH.ICMPH_I_Type (IChdr) is
            ...
            when others =>
               --  AIP.IO.Put_Line ("*** ICMP_Input - Discard ***");
               --  Discard
