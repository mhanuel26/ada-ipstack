...
--                                                                     --
--   Change Packet name for LwIp STM32 port                            --
--   Aug. 2017. Manuel Iglesias                                        --
...
package Connection_State_Machine.Big_Endian.Unsigneds is
--     use Interfaces;  --  gnat don't like this here so we defined in parent public body
...
--
   type Unsigned_8_Data_Item is abstract new Data_Item with record
      Value : Unsigned_8;
   end record;

   type Unsigned_16_Data_Item is abstract new Data_Item with record
      Value : Unsigned_16;
   end record;

   type Unsigned_32_Data_Item is abstract new Data_Item with record
      Value : Unsigned_32;
   end record;

   type Unsigned_64_Data_Item is abstract new Data_Item with record
      Value : Unsigned_64;
   end record;
--
...
--     Layout_Error - Pointer isBig_Endian outside bounds
--
   procedure Put
   ...
   procedure Put (Data    : in out Stream_Element_Array;
                Pointer : in out Stream_Element_Offset;
                Value   : Unsigned_16
             );
   procedure Put
...
end Connection_State_Machine.Big_Endian.Unsigneds;
