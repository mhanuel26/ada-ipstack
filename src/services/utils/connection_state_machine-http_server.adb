...
package body Connection_State_Machine.HTTP_Server is
   use CGI_Keys;
   use Content_Ranges;
   ...
   function From_Digest (Data : Message_Digest) return String;
...
--        end;
   ...
   function Compare (Left, Right : String) return Boolean;
...
--              end if;
   ...
   begin
      pragma Unreferenced (Client, End_Of_Stream);
   ...
   begin
      ...
      Terminated_Strings.Set_Maximum_Size (Client.Line, Client.Request_Length);
   ...
   procedure Process_Request_Line (Client : in out HTTP_Client'Class) is
      Request : String renames Client.Line.Value (1 .. Client.Line.Last);
      Pointer : Integer := Request'First;
      function Get_Version return HTTP_Version;
   ...
   procedure Received
     (Client  : in out HTTP_Client;
      ...
      procedure Multipart_Body (Last : Stream_Element_Offset);
...
--                    end if;
      ...
      procedure WebSocket_Message_End is
         ...
         function Status return WebSocket_Status;
...
--          );
   ...
   begin
      pragma Unreferenced (Client, Key);
      return True;
   end Validate_Key;
...
end Connection_State_Machine.HTTP_Server;
