...
package body Connection_State_Machine is

--     function Available_To_Send (Client : Connection) return Stream_Element_Count
--     is
--        ret_var : Stream_Element_Count;
--     begin
--        --  Todo Port this
...
--     is
--        ret : constant Stream_Element_Count := 0;
--     begin
--        pragma Unreferenced (Client);
--        return ret;
...
--     end Set_Overlapped_Size;
   ...
   begin
      pragma Unreferenced (Data, Pointer);
   ...
   begin
      pragma Unreferenced (Data, Pointer, Client, Item);
      State := 0;
   end Feed;
   ...
   pragma Warnings (Off, "formal parameter * is read *");
   overriding
   procedure Read
   ...
   pragma Warnings (On, "formal parameter * is read *");
