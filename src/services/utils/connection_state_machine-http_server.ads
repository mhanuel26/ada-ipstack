...
with Connection_State_Machine.Expected_Sequence;
with Connection_State_Machine.Terminated_Strings;
with Stack_Storage;
with Tables.Names;

package Connection_State_Machine.HTTP_Server is
   use Strings_Edit.Time_Conversions;
   --
   --  HTTP_Method --  Methods
   --
   type HTTP_Method is
...
private
   use Connection_State_Machine.Expected_Sequence;
   use Connection_State_Machine.Terminated_Strings;
