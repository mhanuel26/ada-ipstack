...
package body Strings_Edit.Time_Conversions is
   ...
   begin
      pragma Unreferenced (Year, Month, Day, Hour, Minute, Second,
                          Sub_Second, Leap_Second, Time_Zone);
      Time_Var := Ada.Real_Time.Clock;
      return Time_Var;
   end Time_Of;

   function Day_of_Week (Date : Time) return RTC_Day_Of_Week;
   function Day_of_Week (Date : Time) return RTC_Day_Of_Week
   is
      Day_Var : RTC_Day_Of_Week;
   begin
...
--     pragma Warnings (Off, "variable * is read but never assigned");
   ...
   function To_String (Date : Time) return String is
      ...
      function Day_Of_Week return String;
      ...
      function Month_Name return String;
...
--              return "GMT";
   ...
   begin
      pragma Unreferenced (Year, Day, Seconds);
      pragma Unreferenced (Day_Of_Week);
      pragma Unreferenced (Month_Name);
      pragma Unreferenced (Zone);
      return "Sun, 17 Feb 2013 21:02:43 +0100";
...
--        );
   ...
   function To_Time (Date : String) return Time is
      ...
      procedure Get_Year (Expand : Boolean);
      procedure Get_Year (Expand : Boolean) is
         Value : Integer;
      begin
         pragma Unreferenced (Expand);
...
--              end if;
         ...
         pragma Unreferenced (Get_Offset);
      begin
         null;
