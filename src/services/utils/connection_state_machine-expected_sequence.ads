...
package Connection_State_Machine.Expected_Sequence is
--
--  Expected_Item --  Expects sequence
--
--     Size - Maximum data length
--
--  The contents Value (1..Size) is checked upon receive.
--
...
end Connection_State_Machine.Expected_Sequence;
