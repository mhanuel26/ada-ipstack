...
package body Generic_Discrete_Set is
   ...
   procedure Delete (Container : in out Set; Index : Positive);
   ...
   function "and" (Left, Right : Set) return Set is
      function Remove (Left : Set; Right : Range_Sets.Set) return Set;
   ...
   function "or" (Left, Right : Set) return Set is
      function Append (Left : Set; Right : Range_Sets.Set) return Set;
